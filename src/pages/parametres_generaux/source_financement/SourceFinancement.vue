...
<!----- ajouter modal   ---->
 ...
 <div id="exampleModal" class="modal hide">
           ...
           <div class="modal-footer"> 
             <button v-show="formData.code.length && formData.libelle.length && formData.sigle.length"
...
<!----- modifier modal debut  ---->
 ...
 <div id="modifierModal" class="modal hide">
           ...
           <div class="modal-footer"> 
             <a @click.prevent="modifierFinancementLocal(editFinancement)" class="btn btn-primary"
              href="#">Modifier</a>
