...
<!----- ajouter modal   ---->
 ...
 <div id="exampleModal" class="modal hide">
           ...
           <div class="modal-footer"> 
             ...
             formData.ordre.length" @click.prevent="ajouterTitreLocal" class="btn btn-primary"
              href="#">Valider</button>
...
<!----- modifier modal debut  ---->
 ...
 <div id="modifierModal" class="modal hide">
           ...
           <div class="modal-footer"> 
             <a @click.prevent="modifierServiceGestionnaireLocal(editGestionnaire)" class="btn btn-primary"
              href="#">Modifier</a>
