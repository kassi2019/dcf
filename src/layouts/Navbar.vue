...
export default {
  ...
  methods: {
    ...mapActions("parametreGenerauxFonctionnelle", [
      "getStructureFonctionnelle",
      "getPlanFonctionnelle"
    ]),
    ...
    ...mapActions("parametreGenerauxBudgetaire", [
      "getStructureBudgetaire",
      "getPlanBudgetaire"
    ]),
    // ...mapActions("parametreGenerauxActivite", [
    ...
    ...mapActions("parametreGenerauxAdministratif", [
      "getExercicesBudgetaires",
      "getTitres",
      "getTypeUniteAdministrative",
      "getNatureSection",
      "getSection",
      "getStructureProgramme",
      "getPlanProgramme",
      "getStructureAdministrative",
      "getServiceGestionnaire",
